...
const Home = () => {
  return (
    <div id='home' className='h-screen pt-20 flex flex-row max-md:flex-col max-md:px-1 justify-center items-center px-60 max-lg:px-32'>

      <div className='flex flex-col gap-2 w-2/5'>
        <marquee className="w-4/5 text-zinc-500 max-md:w-full" behavior="" scrollamount="5" direction="left">Software Development - Web & Mobile Development - DB Management - Data Analysis </marquee>
        ...
        <div className='text-5xl font-bold text-white max-md:text-center max-md:text-4xl max-md:w-full w-2/5'>
